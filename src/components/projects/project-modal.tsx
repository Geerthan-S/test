...
export function ProjectModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] flex items-start justify-center bg-black/80 backdrop-blur-sm p-4 pt-24"
      onClick={onClose}
    >
      {/* Previous Button */}
      {hasPrevious && (
      ...
      {/* Modal */}
      <div
        className="relative bg-white overflow-hidden flex flex-col w-full max-w-6xl max-h-[95vh] rounded-2xl shadow-2xl"
