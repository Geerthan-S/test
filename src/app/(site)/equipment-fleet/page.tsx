...
const fleetCategories = [
  { label: "Tipper Trucks", meta: "Owned:" },
  { label: "Excavators", meta: "" },
  { label: "Motor Graders", meta: "" },
  { label: "Vibro Rollers", meta: "" },
  { label: "JCB Backhoe Loaders", meta: "" },
  { label: "Water Tankers", meta: "" },
];
